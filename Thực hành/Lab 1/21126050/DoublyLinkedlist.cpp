...
void removeDuplicate(DList* &DL) // 17
{
    ...
    while(node1->pNext != NULL)
    {
        ...
        while(node2 != NULL)
        {
            if(node1->pNext->pNext == NULL && node2->key == node1->key) 
            {
                removeTail(DL);
                return;
            }
...
int main()
{
    DNODE* NodeA = createNode(0);
    DList* DList = createDList(NodeA);
    for(int i = 1; i < 7; i++)
        addTail(DList, i);
    cout << "Inital list: ";
    printList1(DList);
    cout << "number of elements List: " << countElements(DList) << endl;
    cout << "add head: ";
    addHead(DList, 2);
    printList1(DList);
    cout << "add tail: ";
    addTail(DList, 2);
    printList1(DList);
    cout << "add number 2 to the 5th place: ";
    addPos(DList, 2, 5);
    printList1(DList);
    cout << "add number 5 before value 4: ";
    addBefore(DList, 5, 4);
    printList1(DList);
    cout << "add number 5 after value 4: ";
    addAfter(DList, 5, 4);
    printList1(DList);
    cout << "reverse List: ";
    printList1(reverseList(DList));
    cout << "add number 7 to the tail (3 times): ";
    addTail(DList, 7);
    addTail(DList, 7);
    addTail(DList, 7);
    cout << "remove head: ";
    ...
    removeTail(DList);
    printList1(DList);
    cout << "remove before node has value 6: ";
    removeBefore(DList, 6);
    printList1(DList);
    cout << "remove after node has value 3: ";
    removeAfter(DList, 3);
    printList1(DList);
    cout << "remove 2th node: ";
    removePos(DList, 2);
    printList1(DList);
    cout << "remove all the duplicates: ";
    removeDuplicate(DList);
    printList1(DList);
    cout << "remove element 4: ";
    removeElement(DList, 4);
    printList1(DList);
    cout << "remove all node: ";
    removeAll(DList);
    printList1(DList);
    return 0;
}